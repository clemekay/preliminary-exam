...
\begin{center}
\vfill
{\large \scshape School of Nuclear Science and Engineering\\Oregon State University}\\[1.4cm]
...
\numberedchapter
\input{MainText/1-introduction.tex} % Import your chapters here
\input{MainText/2-objectives.tex}
\input{MainText/3-method.tex}
\input{MainText/4-results.tex}
\input{MainText/5-schedule.tex}
