...
\newcommand{\name}{Worakrit Thida} % Author name
\newcommand{\thesistitle}{Water wave manipulation using metamaterials} % Title of the thesis
\newcommand{\submissiondate}{October, 2019} % Submission date "Month, year"
\newcommand{\advisor}{Sorasak Danworaphong} % Supervisor name
